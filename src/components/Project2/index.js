...
function Project2() {
  ...
  function checkRepoLink(project) {
    ...
    if (project.repo !== null) {
      return (
        <>
        <a className="repoLink" href={project.repo} target="_blank"><button type="button" className="btn btn-info repoBtn">Repo</button></a>
        <a className="siteLink" href={project.site} target="_blank"><button type="button" className="btn btn-info siteBtn">Website</button></a>
        </>
      )
    } else {
      return <a className="siteLink" href={project.site} target="_blank"><button type="button" className="btn btn-info siteBtn">Website</button></a>
    }
  };
